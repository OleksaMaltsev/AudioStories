...
class TrackBlueContainer extends StatefulWidget {
  const TrackBlueContainer({
    super.key,
    required this.data,
  ...
  @override
  State<TrackBlueContainer> createState() => _TrackContainerState();
}

class _TrackContainerState extends State<TrackBlueContainer> {
